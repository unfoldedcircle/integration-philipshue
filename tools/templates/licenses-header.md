...
The Unfolded Circle Philips Hue integration for Remote Two is part of the firmware.

## Licenses

These are the licenses for the libraries we use in the shipped product as well as for development.

### Licenses for OSS used in Philips Hue integration are reproduced below
